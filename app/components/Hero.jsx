      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
        <div className="lg:col-span-2 place-self-center text-center lg:text-left justify-self-start">
          ...
          <p className="text-[#ADB7BE] text-base sm:text-lg mb-6 lg:text-xl">
            A passionate Data Scientist specializing in Data Engineering. I'm
            committed to tackling real-world challenges, pushing boundaries, and
            delivering innovative solutions. With expertise in Python, and .NET,
            I bring a versatile skill set to every project. Let's collaborate
